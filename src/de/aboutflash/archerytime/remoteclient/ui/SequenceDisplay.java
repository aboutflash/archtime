...
public class SequenceDisplay extends StackPane {
  ...
  private Node getSequenceN() {
    return createCombinedShape(
        "M50,0a50,50,0,1,0,50,50A50,50,0,0,0,50,0ZM72,78.52H58.93l-20-40.75V78.52H28.73V22h13l20.1,41.38V22H72Z");
  }
